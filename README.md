...
- **Solid experience building high-load, real-time systems.**
- **Proficient in Java, Python, REST/WebSocket APIs and microservices.**
- **Comfortable with Docker, Git, Linux/VPS and cloud infrastructure.**
- **Experienced in AI integration and automation.**
...
- **Crypto HFT Arbitrage Bot**  
  ...
  Designed for sub-100 ms market data latency, automatic spread detection and exchange‑specific risk controls.

- **Real-time Market Data & Trading Backend**  
  Low-latency Java backend for a centralized spot/futures exchange: accounts, balances, order lifecycle and market data
  feeds (Java, gRPC, Redis, Docker). Powers multi-tenant analytics and alerting on top of continuous tick/ohlc streams.

- **Web3 Automation & Monitoring Toolkit**  
  Python/Playwright framework that automates Web3 airdrops/retrohunting flows and on‑chain/off‑chain data collection
...
<td><a href="https://linkedin.com/in/sbr7799" target="_blank">
